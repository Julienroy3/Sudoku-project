...
if(isset($_POST["valid_in"])){
    ...
    $rep = $bdd->prepare("INSERT INTO Participe(Temps, IdUser, IdConcours) VALUES (:temps, :user, :concours)");

    $rep->bindParam(":temps", $time, PDO::PARAM_STR);
